...
sa = Event.new(title: "Sans ascenseur",
  ...
  info = Eventinfo.new(event_id: sa.id, number_of_seat: 56, start_time: Time.now, end_time: Time.now + (60 * 60), theater_name:"Boulevard theatre", address:"Baumette Trélazé", unit_price_cents: 59.9 )
